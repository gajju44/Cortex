  ...
  return (
    <>
      ...
      <div className="relative top-0 mx-4 pt-24 sm:mx-8 lg:mx-16 lg:mt-40 lg:pt-2 mb-8">
        <div
          className="relative w-full bg-black/90 overflow-hidden rounded-xl shadow-lg border"
            ...
            >
              ...
              <div className="lg:hidden flex flex-col items-center p-6 sm:p-8 h-full">
                ...
                <div className="space-y-4 mb-8 w-full">
                  <h1
                    className="text-3xl md:text-6xl md:text-center font-bold font-ElMessiri drop-shadow-[0_0_8px]"
                    style={{ color: themeColor }}
                  >
                    {currentSlide.Name}
                  </h1>
                  <p className="text-gray-300  md:text-xl md:text-center leading-relaxed">
                  ...
                  <div className="flex flex-col w-full gap-3 sm:gap-4">
                    <Link
                      ...
                      style={{
                        ...
                        boxShadow: `0 0 15px ${themeColor}70`,
                      }}
                      onMouseEnter={(e) => {
              ...
              <div className="hidden lg:flex items-center h-full p-16">
                <div className="flex flex-row items-center justify-between w-full gap-16">
                  <div className="flex-1 space-y-6 text-left">
                    <h2
                      className="text-6xl font-bold font-ElMessiri drop-shadow-[0_0_8px]"
                      style={{ color: themeColor }}
                    >
                      {currentSlide.Name}
                    </h2>
                    ...
                    <div className="flex gap-4">
                      <Link
                        ...
                        onMouseEnter={(e) => {
                          e.target.style.boxShadow = `0 0 15px${themeColor}`; 
                        }}
                        onMouseLeave={(e) => {
                          e.target.style.boxShadow = `0 0 15px ${themeColor}70`; 
                        }}
                      >
                        Register Event
                      </Link>
                      ...
                      href={`/events-details?Data=${encodeURIComponent(JSON.stringify(currentSlide))}`}
                        ...
                        onMouseEnter={(e) => {
                          e.target.style.backgroundColor = `${themeColor}20`; 
                        }}
                        onMouseLeave={(e) => {
